...
class _MapaScreenState extends State<MapaScreen> {
  ...
  void _cargarMarcadores() {
    // Obtenemos las alertas del historial mediante el método estático del servicio
    final alertas = AlertaService.obtenerHistorial();
  ...
  Future<void> _enviarAlerta() async {
    final enviada = await _alertaService.enviarAlerta(
  ...
  Future<void> cancelarAlerta() async {
    await _alertaService.cancelarAlerta();
    _detenerTimer();
