...
class PerfilUsuarioScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const Color cardDark = Color(0xFF1A1212);
    ...
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              _buildOptionItem(
                ...
                bgColor: cardDark,
                onTap: () {
                  Navigator.pushNamed(context, '/datos-personales');
                },
              ),
              ...
              _buildOptionItem(
                ...
                bgColor: cardDark,
                onTap: () {
                  Navigator.pushNamed(context, '/seguridad-cuenta');
                },
              ),
              ...
              _buildOptionItem(
                ...
                bgColor: cardDark,
                onTap: () {
                  Navigator.pushNamed(context, '/gestionar-contactos');
                },
              ),
              ...
              _buildOptionItem(
                ...
                bgColor: cardDark,
                onTap: () {
                  Navigator.pushNamed(context, '/preferencias-notificacion');
                },
              ),
      ...
      bottomNavigationBar:
      const UsuarioBottomNavWidget(currentIndex: 3),
    );
  }
  ...
  static void _mostrarDialogoCerrarSesion(BuildContext context) {
    showDialog(
      context: context,
