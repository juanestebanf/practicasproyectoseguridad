...
class _OperadoresScreenState extends State<OperadoresScreen> {
  ...
  void initState() {
    super.initState();
    operators = repository.getOperators();
  }
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          child: Text(
                            operator.nombre.substring(0, 1).toUpperCase(),
                        ...
                        // ✅ SOLUCIÓN AL OVERFLOW: Quitamos la Column y dejamos solo el Switch estilizado
                        trailing: Switch(
                          ...
                          onChanged: (_) {
                            setState(() {
                              repository.toggleOperatorStatus(operator.id);
                            });
                          },
                        ),
                      ),
